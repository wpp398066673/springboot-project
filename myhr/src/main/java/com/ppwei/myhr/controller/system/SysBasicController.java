package com.ppwei.myhr.controller.system;

import com.ppwei.myhr.bean.*;
import com.ppwei.myhr.service.*;
...
public class SysBasicController {
    ...
    public List<Department> loadTreeData(@PathVariable("pid") Long pid){
